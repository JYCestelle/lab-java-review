...
public class Tester {
	...
	public static void main(String[] args){
      ...
      //Dog.bark();
      Husky husky = new Husky("myHusky");
      husky.bark();
      husky.pullSled();
      //pups.pullSled(); doesn't work
      //Dog v1 = new Husky();
      //Husky v2 = new Dog();
      ...
      hugList.add(new Husky("uw")); //a Husky is Huggable
   ...
   //read: "for each Huggable in the hugList"
      ...
      //Animal animal = new Animal(); this test failed because animal is an abstract class
      GiftBox<Husky> gift = new GiftBox(husky);
	}
}